...
# Query to select all bear names and order them in alphabetical order
...
# Query to select all bear names and ages that are alive, ordered from youngest to oldest
